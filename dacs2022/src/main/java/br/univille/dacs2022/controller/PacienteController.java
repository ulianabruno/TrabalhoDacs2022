...
public class PacienteController {
    ...
    public ModelAndView novo(){
        ...
        var listaPlanoSaude = planoSaudeService.getAll();
        HashMap<String, Object> dados = new HashMap<>();
        dados.put("paciente", paciente);
        dados.put("listaCidades", listaCidades);
        dados.put("listaPlanoSaude", listaPlanoSaude);
    ...
    public ModelAndView incluirPlano(@Valid @ModelAttribute("paciente") 
        ...
        var idPlanoSelect = paciente.getPlanoSaudeId();
        var planoSelect = planoSaudeService.getById(idPlanoSelect);
        paciente.getListaPlanoSaude().add(planoSelect);
    ...
    public ModelAndView removerPlano(@Valid @ModelAttribute("paciente") 
                                ...
                                BindingResult bindingResult){
        paciente.getListaPlanoSaude().remove(index);
